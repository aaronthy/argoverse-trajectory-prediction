...
print("all_future shape:", all_future.shape)
print("all_others shape:", all_others.shape)

np.save('/mnt/d/argoverse_data/train_obs.npy', all_obs)
np.save('/mnt/d/argoverse_data/train_future.npy', all_future)
np.save('/mnt/d/argoverse_data/train_others.npy', all_others)
